package com.varm.textclassifier.naivebayesnetwork.service;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.varm.featureextractor.model.Feature;
import com.varm.featureextractor.service.FeatureService;
import com.varm.textclassifier.datasetprocessor.model.Document;
import com.varm.textclassifier.datasetprocessor.service.DocumentService;
import com.varm.textclassifier.datasetprocessor.tokenizer.TextTokenizer;
import com.varm.textclassifier.naivebayesnetwork.model.NaiveBayesNetwork;
...
public class NaiveBayesService {
	 ...
	 * 
	 */
	public static NaiveBayesNetwork train(Map<String, String[]> trainingDataset, Map<String, Double> categoryPriors)
	...
	//	System.out.println("Dataset: " + dataset.toString());
		...
		NaiveBayesNetwork knowledgeBase = new NaiveBayesNetwork();
	 ...
	 * 
	 */
	public static NaiveBayesNetwork train(Map<String, String[]> trainingDataset) {
	 ...
	 * @throws IllegalArgumentException
	 */
	public static String predict(String text, NaiveBayesNetwork knowledgeBase) throws IllegalArgumentException {
